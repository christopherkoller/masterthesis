...
def from_latlon(latitude, longitude, force_zone_number=None):
    ...
    easting, northing, zone_number, zone_letter = _from_latlon(latitude, longitude, force_zone_number)

    return easting, northing, "{0}{1}".format(zone_number, zone_letter)


def _from_latlon(latitude, longitude, force_zone_number=None):
